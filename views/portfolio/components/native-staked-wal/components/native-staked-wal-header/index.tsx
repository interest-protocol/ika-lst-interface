...
import { NativeStakedWalHeaderProps } from './native-staked-wal-header.types';
import StatBox from './stat-box';

const NativeStakedWalHeader: FC<NativeStakedWalHeaderProps> = ({
  totalTokens,
  totalValue,
}) => (
  <Div
...
export default NativeStakedWalHeader;
