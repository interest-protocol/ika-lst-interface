...
import { NativeStakedWalRowButtonStatusProps } from './native-staked-wal-row-button-status.types';

const NativeStakedWalRowButtonStatus: FC<
  NativeStakedWalRowButtonStatusProps
> = ({ status }) => {
...
export default NativeStakedWalRowButtonStatus;
